            ...
            <Col xs={12} sm={6} md={3} lg={3}>
              ...
              <div>
                <a href="#" className="text-decoration-none text-white">
                  ...
                  <span className="ms-2">Security Guard</span>
                </a>
              </div>
              <div>
                <a href="#" className="text-decoration-none text-white">
                  ...
                  <span className="ms-2">Security Incharge</span>
                </a>
              </div>
              <div>
                <a href="#" className="text-decoration-none text-white">
                  ...
                  <span className="ms-2">Supervisar</span>
                </a>
              </div>
              <div>
                <a href="#" className="text-decoration-none text-white">
                  ...
                  <span className="ms-2">VIP Guard</span>
                </a>
              </div>
            </Col>
            <Col xs={12} sm={6} md={3} lg={3}>
